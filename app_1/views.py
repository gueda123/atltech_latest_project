...
def dashboard_customer_order_edit_Generate_Invoice1(request):
    ...
    if staff_admin or staff_shop_manager or staff_upload_team:
        ...
        p.drawString(320, 780, "ATLTECH SHOPPING")
        p.drawString(320, 765, "")
        p.drawString(320, 750, "Thank You For Ordering Us")
        p.drawString(320, 735, "We Deliver Quality Products")
        p.drawString(320, 720, "Mail: support@atltech.xyz")
        ...
        p.setFillColor(blue)
        p.drawString(190, 45, "Thank you for shopping with ATLTECH")
        p.drawString(241, 30, "We Deliver Quality")
        p.drawString(225, 15, "WWW.atltech.xyz")
