...
urlpatterns = [
    ...
    # old order analytics
    path('dashboard_old_order_report', views5.dashboard_old_order_report, name="dashboard_old_order_report"),
    ...
    path('reset_password', views5.reset_password, name="reset_password"),
]