...
import random
from campaign.models import Vendor_notifications
...
def third_stap_to_save_vendor_registration(request):
    ...
    if filter_email:
        ...
        get_Notification_text = f'A new vendor request (Name: {vendor_registration_Shop_Name}) '

        order_base_notificationsk = Vendor_notifications(Notification_vendor=s, Notification_text=get_Notification_text)
        order_base_notificationsk.save()
